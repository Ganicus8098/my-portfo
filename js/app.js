(() => {
 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        const buttonLangs = document.querySelector(".langs__btn-langs");
        const contentLangs = document.querySelector(".langs__langs-content");
        if (buttonLangs) buttonLangs.addEventListener("click", (function(e) {
            buttonLangs.classList.toggle("_sub-menu-show");
            if (contentLangs) contentLangs.classList.toggle("_sub-menu-show");
        }));
        ...
        window.addEventListener("scroll", (() => {
            if (window.scrollY > 500) btn.classList.add("anim-show"); else btn.classList.remove("anim-show");
        }));
